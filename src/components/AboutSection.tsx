...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="relative min-h-screen w-full bg-[#0C0C0C] px-5 sm:px-10 md:px-20 py-20 flex flex-col items-center justify-center overflow-hidden">
